    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _DemoTile(Icons.record_voice_over, l10n.ttsTitle, Routes.textToSpeech),
          _DemoTile(Icons.mic, l10n.sttTitle, Routes.speechToText),
          _DemoTile(Icons.security, l10n.screenProtectorTitle, Routes.screenProtector),
          _DemoTile(Icons.qr_code_2, l10n.qrTitle, Routes.qrCode),
          _DemoTile(Icons.chat, l10n.chatTitle, Routes.chat),
          _DemoTile(Icons.auto_stories, l10n.storiesTitle, Routes.stories),
          _DemoTile(Icons.crop, l10n.cropTitle, Routes.imageCrop),
          _DemoTile(Icons.document_scanner, l10n.docScanTitle, Routes.documentScanner),
          _DemoTile(Icons.tag, l10n.idsTitle, Routes.uniqueIds),
        ],
      ),
    );
  }
